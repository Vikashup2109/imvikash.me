...
export default function ProjectPage({ params }: ProjectPageProps) {
  ...
  return (
    <main className="relative w-full p-0 sm:p-5">
      <div className="sticky top-0 w-full h-screen rounded-2xl  flex flex-wrap justify-between lg:divide-x">
        <div className="relative w-full lg:w-2/5 p-2 md:p-8">
          <div className="flex justify-between mb-2">
            <Link href="/projects" className="group/back text-xs">
              <ArrowLeft
                size={18}
                className="group-hover/back:-translate-x-1 transition-transform transform-gpu duration-100 ease-in-out"
              />
              <span className="sr-only">iamvikash.me</span>
            </Link>
